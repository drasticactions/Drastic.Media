...
namespace Drastic.Media.Core.Services
{
    public static class NotificationHelper
    {
        ...
        public static Notification.Action GenerateActionCompat(Context context, int icon, string title, string intentAction)
        {
        ...
        public static void AddPlayPauseActionCompat(
