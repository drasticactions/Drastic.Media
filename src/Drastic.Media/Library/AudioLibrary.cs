...
using Drastic.Media.Core;
using Drastic.Media.Core.Database;
using Drastic.Media.Core.Library;
using Drastic.Media.Core.Metadata;
using Drastic.Media.Core.Model;
using Drastic.Media.Core.Platform;
using Drastic.Media.Core.Tools;
using Microsoft.Extensions.Logging;

namespace Drastic.Media.Audio.Library
{
